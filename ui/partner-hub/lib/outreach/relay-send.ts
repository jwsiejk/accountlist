 ...
 * same inbox (see OUTREACH_SETUP.md), so this never has to cross into
...
/** Distinct from anything containing "SC26" on purpose -- see docs/OUTREACH_SETUP.md
 ...
 * OUTREACH_SETUP.md. If that ever needs to be a different address than
 * the Resend account's own email, a verified sending domain would be
 * needed instead.
 */
const RESEND_FROM_ADDRESS = "DDN Outreach <onboarding@resend.dev>";
