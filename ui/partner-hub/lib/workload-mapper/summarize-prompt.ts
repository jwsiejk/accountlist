...
export function buildSummarizePrompt(input: WorkloadSummaryRequest): string {
  ...
  return [
    ...
    "Use the field values as facts and blend them into natural sentences.",
    "Do not quote field values back to the user unless the quote is naturally part of the summary.",
    "Do not say \"as stated by,\" \"as entered,\" \"the field says,\" \"the input says,\" \"which translates to,\" or similar source-referencing language.",
    "Do not explain which fields were used to build the summary.",
    "The reader should receive the workload summary only, not a description of how the summary was produced.",
