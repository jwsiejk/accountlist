import type { CatalogSourcePackId, CatalogSourcePackInput } from "./sourceCatalogTypes";

export const DEFAULT_PACK_ORDER: CatalogSourcePackId[] = [
...
export const RAW_CATALOG_SOURCE_PACKS: CatalogSourcePackInput[] = [
  {
