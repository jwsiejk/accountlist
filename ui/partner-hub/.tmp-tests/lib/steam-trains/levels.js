...
exports.getFirstLevelId = exports.getLevelDefinition = exports.STEAM_TRAINS_LEVELS = void 0;
exports.STEAM_TRAINS_LEVELS = [
    {
...
const levelById = new Map(exports.STEAM_TRAINS_LEVELS.map((level) => [level.id, level]));
const getLevelDefinition = (id) => {
...
const getFirstLevelId = () => exports.STEAM_TRAINS_LEVELS[0]?.id ?? "";
exports.getFirstLevelId = getFirstLevelId;
