...
exports.resolveTrainCarLayers = exports.STEAM_PLUME_LAYERS = exports.SCENE_LAYERS = exports.BACKDROP_LAYERS = exports.FREIGHT_CAR_ASSET_LAYERS = exports.PASSENGER_CAR_ASSET_LAYERS = exports.TENDER_ASSET_LAYERS = exports.pickLocomotiveAssetFamily = void 0;
const BASE_FREIGHT_FAMILY = {
    pilot: [
...
const pickLocomotiveAssetFamily = (loco) => {
    if (loco.wheelSet.count <= 2)
        return BASE_SWITCHER_FAMILY;
    if (loco.wheelSet.count >= 4)
        return BASE_FREIGHT_FAMILY;
    return BASE_PASSENGER_FAMILY;
};
exports.pickLocomotiveAssetFamily = pickLocomotiveAssetFamily;
exports.TENDER_ASSET_LAYERS = [
...
exports.PASSENGER_CAR_ASSET_LAYERS = [
...
exports.FREIGHT_CAR_ASSET_LAYERS = [
...
const resolveTrainCarLayers = (train) => train.id.includes("passenger") ? exports.PASSENGER_CAR_ASSET_LAYERS : exports.FREIGHT_CAR_ASSET_LAYERS;
exports.resolveTrainCarLayers = resolveTrainCarLayers;
