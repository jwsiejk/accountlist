...
exports.stepSteamParticles = exports.emitSteamParticles = void 0;
const emitSteamParticles = (particles, emitter, originX, originY, dtMs, intensity, nextParticleId) => {
...
exports.emitSteamParticles = emitSteamParticles;
const stepSteamParticles = (particles, dtMs) => particles
    .map((particle) => {
...
exports.stepSteamParticles = stepSteamParticles;
