...
const masterResume_1 = require("./masterResume");
const tailor_1 = require("./tailor");
(0, node_test_1.describe)("generateTailoringPacket", () => {
    (0, node_test_1.it)("builds json and markdown packet outputs", () => {
        const job = {
            id: "lever:123",
        ...
        const packet = (0, tailor_1.generateTailoringPacket)(job, masterResume_1.masterResume);
    ...
    (0, node_test_1.it)("uses preferences when calculating fit", () => {
        const job = {
            id: "pref:789",
        ...
        const withoutPreferences = (0, tailor_1.generateTailoringPacket)(job, masterResume_1.masterResume);
        const withExclusion = (0, tailor_1.generateTailoringPacket)(job, masterResume_1.masterResume, {
            targetRoles: [],
            targetKeywords: [],
            targetLocations: [],
    ...
    (0, node_test_1.it)("supports resume profile input", () => {
        const job = {
            id: "greenhouse:456",
            title: "Solutions Architect",
            company: "Acme",
        ...
        const packet = (0, tailor_1.generateTailoringPacket)(job, {
            fullName: "James Wang",
    ...
    (0, node_test_1.it)("falls back to default signature and signer when resume profile identity is blank", () => {
        const job = {
    ...
    (0, node_test_1.it)("uses posting snapshot notes in tailored outputs", () => {
        const job = {
            id: "lever:notes",
