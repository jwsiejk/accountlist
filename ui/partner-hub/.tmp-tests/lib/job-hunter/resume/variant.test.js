...
(0, node_test_1.describe)("generateTailoredResumeVariant", () => {
    (0, node_test_1.it)("does not mutate the base profile", () => {
        const job = {
            id: "job-1",
        ...
        (0, variant_1.generateTailoredResumeVariant)(job, baseProfile);
        const after = JSON.stringify(baseProfile);
        assert.equal(after, before);
    });
    (0, node_test_1.it)("only uses source skills and bullets", () => {
        const job = {
            id: "job-2",
        ...
        const variant = (0, variant_1.generateTailoredResumeVariant)(job, baseProfile);
    ...
    (0, node_test_1.it)("prioritizes matching skills and generates artifacts with delta summary", () => {
        const job = {
            id: "job-3",
