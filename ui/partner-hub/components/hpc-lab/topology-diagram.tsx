...
export function TopologyDiagram({ model }: { model: HpcLabTopologyModel }) {
  return (
    <div className="space-y-3">
      ...
      <div className="rounded border border-border/70 bg-card px-3 py-2 text-center text-xs text-foreground/70">Network fabric · {model.networkBandwidthGbps} Gbps</div>
