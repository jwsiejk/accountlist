...
function displayMetrics(metrics: AiFactoryRunMetrics | null, status: AiFactoryRunStatus): DisplayMetric[] {
  ...
  return [
    ...
    },
    {
      ...
      help: "Estimated; Phase 4 does not add an exact tokenizer dependency.",
    },
    {
      label: "Response tokens",
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/70 bg-muted/20 p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-foreground/60">Phase 4 local run metrics</p>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 text-amber-800 dark:text-amber-200">
          ...
          <p className="mt-1 text-xs">
            GPU telemetry, watts, tokens/watt, and real cost/run are not measured in Phase 4 and remain demo/mock or unavailable for live runs.
          </p>
        </div>
      </div>
