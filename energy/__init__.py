...
def index():
    ...
    defaults = {
        "pure_util": "50", "pure_pue": "1.35", "pure_price": "0.12", "pure_drr": "2.0",
        "na_util": "50", "na_pue": "1.35", "na_price": "0.12", "na_overhead": "0.20", "na_drr": "1.3", "na_drive_size": "18",
        # Global defaults surfaced in the new card
        "global_util_pct": "50", "global_price": "0.12"
    }
...
# Drive-size discovery helpers (uses Allowed_Drive_TB if present; else bay-based defaults)
...
def results():
    ...
    # Expose for the template (override JS depends on these)
    ...
    return render_template("energy/results.html",
                           ...
                           candidates=cands, band_low=fb['effective_tb']*(1.0-tol_frac), band_high=fb['effective_tb']*(1.0+tol_frac),
